  ...
  return (
    <html>
      <head>
        ...
        <title>Nouveau message - SimplyJury</title>
        <style>{`
        ...
        <div className="container">
          ...
          <div className="content">
            ...
            <div className="message">
              Vous avez reçu un nouveau message de <strong>{senderName}</strong> du centre de formation <strong>{centerName}</strong> sur SimplyJury.
            </div>
            
            <div className="details-card">
              <div className="detail-item">
                <div className="detail-icon"></div>
                <span className="detail-label">Expéditeur :</span>
                <span className="detail-value">{senderName}</span>
              </div>
              <div className="detail-item">
                <div className="detail-icon"></div>
            ...
            <div className="message">
              Pour consulter ce message et y répondre, connectez-vous à votre espace jury.
            </div>
            ...
            <div className="message" style={{ fontSize: '14px', color: '#64748b', marginTop: '30px' }}>
              Vous recevrez une notification par email à chaque nouveau message. Vous pouvez gérer vos préférences de notification dans les paramètres de votre compte.
            </div>
          </div>
